      ...
      <main className="app-shell page-in">
        <section className="app-hero">
          <div>
            ...
            <p className="app-lead">area が空です。URLをご確認ください。</p>
      ...
      <main className="app-shell page-in">
        <section className="app-hero">
          <div>
            ...
            <p className="app-lead">対象データがありません。</p>
            <div className="mt-4 flex flex-wrap gap-2">
              <Link className="app-button app-button--ghost" href="/rankings">
                ランキング一覧へ
              </Link>
    ...
    <main className="app-shell page-in">
      ...
      <nav className="mt-8 flex flex-wrap gap-2 justify-between text-sm">
        <Link
          ...
          href={`/rankings/area/${encodeURIComponent(area)}?page=${prevPage}`}
        >
          ← 前へ
        </Link>
            ...
            return (
              <span key={p} className="flex items-center gap-2">
                ...
                {p === currentPage ? (
                  ...
                  <Link
                    className="app-button app-button--ghost"
                    href={`/rankings/area/${encodeURIComponent(area)}?page=${p}`}
                  >
                    {p}
                  </Link>
                )}
        ...
        <Link
          ...
          href={`/rankings/area/${encodeURIComponent(area)}?page=${nextPage}`}
        >
          次へ →
        </Link>
      </nav>
